...
class ViewServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        View::composer('control-panel.content_details.*', function ($view) {
            View::share('activeNavItem', 'content-details');
        });

        View::composer('control-panel.spreadsheets.*', function ($view) {
            View::share('activeNavItem', 'spreadsheets');
        });
    }
}
