<div class="card">
  ...
  <div class="card-head d-flex justify-content-between align-items-center">
    ...
    <div>
      @can('update', $user)
        <x-buttons.anchor :href="route('users.edit', $user)" content="Edit writer" size="small" color="warning" class="my-1" />
      @endcan
      @can('delete', $user)
        <x-buttons.form :action="route('users.destroy', $user)" content="Delete writer" size="small" color="danger" class="my-1" />
      @endcan
    </div>
