...
<nav class="col-2 h-100 px-0 navbar position-fixed navbar-expand-lg bg-dark d-flex align-items-start">
  <div class="container px-0">
    <ul class="navbar-nav flex-column mx-auto">
      ...
      <li class="nav-item">
        <a class="nav-link @if ($activeNavItem === 'content-details') bg-primary bg-gradient @endif ps-3 pe-5 text-white"
          href="{{ route('content-details.index') }}">
      ...
      <li class="nav-item">
        <a class="nav-link @if ($activeNavItem === 'spreadsheets') bg-primary bg-gradient @endif ps-3 pe-5 text-white"
